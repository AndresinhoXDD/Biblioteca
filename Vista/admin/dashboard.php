...
<div class="row mb-4">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h2 class="card-title"><i class="fas fa-tachometer-alt me-2"></i>Panel de Administración</h2>
                <p class="card-text">Bienvenido, <?php echo $_SESSION['nombre']; ?>. Desde aquí puedes administrar todas las funciones del sistema.</p>
            </div>
        </div>
    </div>
</div>
